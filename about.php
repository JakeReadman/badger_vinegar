...
<body class="animsition">
    ...
    <section class="bg-img1 txt-center p-lr-15 p-tb-92"
        style="background-image: url('images/slider_images/bg-01.jpg'); opacity: 0.8">
        ...
        <div class="container">
            <div class="row p-b-148">
                ...
                <div class="col-11 col-md-5 col-lg-4 m-lr-auto">
                    <div class="how-bor1 ">
                        <div class="hov-img0">
                            <img src="images/content/about-01.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
                        ...
                        <div class="bor16 p-l-29 p-b-9 m-t-22">
                            <p class="stext-114 cl6 p-r-40 p-b-11">
                                When you acknowledge, as you must, that there is no such thing as perfect food, only the
                                idea of it, then the real purpose of striving toward perfection becomes clear: to make
                ...
                <div class="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                    <div class="how-bor2">
                        <div class="hov-img0">
                            <img src="images/content/about-02.jpg" alt="IMG">
                        </div>
                    </div>
                </div>
            </div>
